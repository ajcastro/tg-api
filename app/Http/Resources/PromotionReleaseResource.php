...
class PromotionReleaseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'deposit_amount_display' => number_format($this->resource->memberPromotion->deposit_amount),
            'bonus_amount' => $this->resource->memberPromotion->bonus_amount,
            'bonus_amount_display' => number_format($this->resource->memberPromotion->bonus_amount),
            'obligation_amount' => $this->resource->memberPromotion->obligation_amount,
            'obligation_amount_display' => number_format($this->resource->memberPromotion->obligation_amount),
            'turn_over_amount' => $this->resource->memberPromotion->turn_over_amount,
            'turn_over_amount_display' => number_format($this->resource->memberPromotion->turn_over_amount),
